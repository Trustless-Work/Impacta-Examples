...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url https://soroban-testnet.stellar.org --network-passphrase \"Test SDF Network ; September 2015\" --id CBT26NZLY5EZTA7YXACH6DZD43SNG3LRIB52LDUV7TIH3RWR7KT45EXZ --name bindings"
}
```
